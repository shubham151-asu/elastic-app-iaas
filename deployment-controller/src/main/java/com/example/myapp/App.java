...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // s3Client.putObject(PutObjectRequest.builder().bucket(projectInstances.bucketName).key(s3BucketKey)
        //                 .build(),
    ...
    public static ProjectInstances launchProject(S3Client s3Client, SqsClient sqsClient, Ec2Client ec2Client, VelocityEngine ve)
        ...
        // String appInstanceId = createEc2Instance(ec2Client, APP_TIER_AMI_ID, "app-tier", 
        // readUserDataFile(ve, CONTROLLER_USER_DATA_FILE_PATH, inputBucketName, outputBucketName, requestQueueUrl, responseQueueUrl), S3_IAM_ROLE);
